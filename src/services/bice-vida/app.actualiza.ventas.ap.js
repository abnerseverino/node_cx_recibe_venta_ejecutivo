...
const capturaLooker = async () => {
  try {
    ...
    const lookerURL =
      "https://lookerstudio.google.com/u/0/reporting/3a97ace1-9981-4e08-a99b-7e439a960812/page/p_3w18mfg6td";
    ...
    const ajusteQuery = `
      ...
      WHERE ven_eje_campana_id = 48 AND 
